...
It invokes ZLUDA's source-build `zluda_precompile.exe` when available and then executes a small dynamic training warmup. The cache remains local to the user and is never committed.
